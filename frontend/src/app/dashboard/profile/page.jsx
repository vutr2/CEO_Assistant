...
import {
  ...
  TrendingUp, Target, Clock, CheckCircle, Edit, Settings,
  BarChart3, Users, MessageSquare, Star, FileText, Bot,
  Upload, UserPlus, BarChart, DollarSign, Trophy, BarChart2,
  Rocket, Database, ClipboardCheck
} from 'lucide-react';
...
const iconMap = {
  Target, CheckCircle, Users, TrendingUp, User, Mail, Phone, MapPin,
  Calendar, Briefcase, Award, Clock, Edit, Settings, BarChart3,
  MessageSquare, Star, FileText, Bot, Upload, UserPlus, BarChart,
  DollarSign, Trophy, BarChart2, Rocket, Database, ClipboardCheck
};
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        const [profileData, perfData, statsData, skillsData, activitiesData, achievementsData] = await Promise.all([
          userAPI.getProfile(),
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Không thể tải hồ sơ</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 -mt-16 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-600 mt-1">{userProfile.position}</p>
                <div className="flex flex-wrap gap-4 mt-3 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-2">
                    <Calendar size={16} />
                    <span>Tham gia {formatDate(userProfile.joinDate)} ({getYearsWorked()} năm)</span>
                  </div>
                </div>
              </div>

              <div className="flex gap-2">
                <Button variant="outline" icon={Edit} href="/dashboard/settings/account">
                  Chỉnh sửa
                </Button>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
          ...
          <div className="p-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Hiệu suất làm việc năm 2025</h3>
                  <div className="h-80">
                      ...
                      <BarChart data={performanceData}>
                        ...
                        <Tooltip
                          ...
                          formatter={(value, name) => {
                            ...
                            if (name === 'efficiency') return [value + '%', 'Hiệu suất'];
                            return [value, name];
                          }}
                        />
                        <Legend
            ...
            {activeTab === 'activity' && (
              <div className="space-y-4">
                ...
                {recentActivities.map((activity) => {
                  ...
                  return (
                    <div key={activity.id} className="flex gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
            ...
            {activeTab === 'skills' && (
              <div className="space-y-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Kỹ năng chuyên môn</h3>
            ...
            {activeTab === 'achievements' && (
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">Thành tích & Giải thưởng</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {achievements.map((achievement, index) => {
                    const Icon = iconMap[achievement.icon] || Trophy;
                    return (
                      <div key={index} className="flex items-center gap-4 p-6 bg-gray-50 rounded-xl hover:shadow-md transition">
                        <div className={`w-16 h-16 bg-${achievement.color}-100 rounded-full flex items-center justify-center`}>
                          <Icon className={`text-${achievement.color}-600`} size={28} />
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900">{achievement.name}</h4>
                          <p className="text-sm text-gray-600 mt-1">Đạt được năm 2025</p>
                        </div>
                      </div>
                    );
                  })}
